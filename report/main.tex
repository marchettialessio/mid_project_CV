...
\begin{enumerate}
    \item add the images and labels folders in the \texttt{resources} folder, and diveded respectively in the \texttt{data} and \texttt{labels} folder;
...
\begin{enumerate}
    \item every \texttt{hybridApproachRate} iterations, the \texttt{updateTrackedKeypoints} method is called, and \textit{minMotion} is increased, in order to track only relevant features;
